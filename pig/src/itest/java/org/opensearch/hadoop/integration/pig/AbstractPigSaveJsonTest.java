...
public class AbstractPigSaveJsonTest extends AbstractPigTests {
    ...
    public void testTuple() throws Exception {
        String script =
                ...
                loadSource() +
                //"ILLUSTRATE A;" +
                "STORE A INTO '"+resource("json-pig-tupleartists", "data", VERSION)+"' USING org.opensearch.pig.hadoop.EsStorage('es.input.json=true');";
    ...
    public void testFieldAlias() throws Exception {
        String script =
                loadSource() +
                "STORE A INTO '"+resource("json-pig-fieldalias", "data", VERSION)+"' USING org.opensearch.pig.hadoop.EsStorage('es.input.json=true','es.mapping.names=data:@json');";
    ...
    public void testCreateWithId() throws Exception {
        String script =
                loadSource() +
                "STORE A INTO '"+resource("json-pig-createwithid", "data", VERSION)+"' USING org.opensearch.pig.hadoop.EsStorage('"
    ...
    public void testUpdateWithoutId() throws Exception {
        String script =
                loadSource() +
                "STORE A INTO '"+resource("json-pig-updatewoid", "data", VERSION)+"' USING org.opensearch.pig.hadoop.EsStorage('"
    ...
    public void testUpdateWithId() throws Exception {
        String script =
                loadSource() +
                "STORE A INTO '"+resource("json-pig-update", "data", VERSION)+"' USING org.opensearch.pig.hadoop.EsStorage('"
    ...
    public void testUpdateWithoutUpsert() throws Exception {
        String script =
                loadSource() +
                "STORE A INTO '"+resource("json-pig-updatewoupsert", "data", VERSION)+"' USING org.opensearch.pig.hadoop.EsStorage('"
                                + ConfigurationOptions.ES_WRITE_OPERATION + "=update','"
                                + ConfigurationOptions.ES_MAPPING_ID + "=number',"
                                + "'es.input.json=true');";
        pig.executeScript(script);
    ...
    public void testParentChild() throws Exception {
        ...
        String script =
                loadSource() +
                "STORE A INTO 'json-pig-pc/child' USING org.opensearch.pig.hadoop.EsStorage('"
    ...
    public void testIndexPattern() throws Exception {
        String script =
                loadSource() +
                "STORE A INTO '"+resource("json-pig-pattern-{tag}", "data", VERSION)+"' USING org.opensearch.pig.hadoop.EsStorage('es.input.json=true');";
    ...
    public void testIndexPatternFormat() throws Exception {
        String script =
                loadSource() +
                "STORE A INTO '"+resource("json-pig-pattern-format-{@timestamp|YYYY-MM-dd}", "data", VERSION)+"' USING org.opensearch.pig.hadoop.EsStorage('es.input.json=true');";
