[![Build & Test MapReduce](https://github.com/opensearch-project/opensearch-java/actions/workflows/build-mr.yml/badge.svg?branch=main)](https://github.com/opensearch-project/opensearch-java/actions/workflows/build-mr.yml)
[![Build & Test Spark](https://github.com/opensearch-project/opensearch-java/actions/workflows/build-spark.yml/badge.svg?branch=main)](https://github.com/opensearch-project/opensearch-java/actions/workflows/build-spark.yml)
[![Build & Test Hive](https://github.com/opensearch-project/opensearch-java/actions/workflows/build-hive.yml/badge.svg?branch=main)](https://github.com/opensearch-project/opensearch-java/actions/workflows/build-hive.yml)
[![Build & Test Pig](https://github.com/opensearch-project/opensearch-java/actions/workflows/build-pig.yml/badge.svg?branch=main)](https://github.com/opensearch-project/opensearch-java/actions/workflows/build-pig.yml)
[![Build & Test Storm](https://github.com/opensearch-project/opensearch-java/actions/workflows/build-storm.yml/badge.svg?branch=main)](https://github.com/opensearch-project/opensearch-java/actions/workflows/build-storm.yml)
