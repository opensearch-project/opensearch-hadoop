...
### Dependencies
- Bumps `com.fasterxml.jackson.core:jackson-databind` from 2.17.2 to 2.20.1
...
- Bumps `com.google.protobuf:protobuf-java` from 4.28.2 to 4.33.1
- Bumps `commons-codec:commons-codec` from 1.17.1 to 1.20.0
...
- Bumps `software.amazon.awssdk:utils` from 2.38.2 to 2.39.2
