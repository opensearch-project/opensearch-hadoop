...
### Dependencies
- Bumps `com.google.protobuf:protobuf-java` from 3.22.3 to 3.24.2
- Bumps `com.esotericsoftware.kryo:kryo` from 2.21 to 2.24.0
- Bumps `io.netty:netty-all` from 4.1.92.Final to 4.1.97.Final
...
- Bumps `com.amazonaws:aws-java-sdk-bundle` from 1.12.451 to 1.12.576
